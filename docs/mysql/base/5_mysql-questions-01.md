...
读写分离和分库分表相关的问题比较多，于是，我单独写了一篇文章来介绍：[读写分离和分库分表详解](docs/high-performance/sql-optim/read-and-write-separation-and-library-subtable.md)。

### 深度分页如何优化？

[深度分页介绍及优化建议](docs/high-performance/sql-optim/deep-pagination-optimization.md)

### 数据冷热分离如何做？

[数据冷热分离详解](docs/high-performance/sql-optim/data-cold-hot-separation.md)

### 常见的数据库优化方法有哪些？

- [索引优化](./mysql-index.md)
- [读写分离和分库分表](docs/high-performance/sql-optim/read-and-write-separation-and-library-subtable.md)
- [数据冷热分离](docs/high-performance/sql-optim/data-cold-hot-separation.md)
- [SQL 优化](docs/high-performance/sql-optim/sql-optimization.md)
- [深度分页优化](docs/high-performance/sql-optim/deep-pagination-optimization.md)
- 适当冗余数据
- 使用更高的硬件配置
